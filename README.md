...
> A polyhedral content viewer for the web. Organize content on the faces of a cube, dodecahedron, or any convex polyhedron — with a proprietary 3D engine and full DOM interactivity.

[![npm](https://img.shields.io/npm/v/polyfacelib.svg)](https://www.npmjs.com/package/polyfacelib)
[![bundle size](https://img.shields.io/bundlephobia/minzip/polyfacelib)](https://bundlephobia.com/package/polyfacelib)
[![license](https://img.shields.io/npm/l/polyfacelib)](./LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/Lancrey/polyfacelib?style=social)](https://github.com/Lancrey/polyfacelib)
...
1. Advances the current quaternion via `slerp(from, to, easedT)`.
2. Transforms each face's vertices into world space.
3. Builds the final 4×4 matrix combining rotation, camera translation, and perspective division — **entirely in our code, no CSS perspective involved**.
4. Sorts faces by depth for correct transparency compositing.
5. Writes the resulting `matrix3d(…)` string and computed opacity to each face's DOM element.
...
```ts
// Plain text, rendered as styled DOM
...
| Breakpoint | Width    | Defaults                                                  |
|------------|----------|-----------------------------------------------------------|
| Mobile     | < 640px  | `controls: 'edges'`, `swipeMode: 'edge'`, ≥ 44px touch    |
| Tablet     | 640–1024 | `controls: 'edges'`, swipe + click                        |
| Desktop    | > 1024   | `controls: 'none'`, swipe + click + keyboard              |
...
Issues and pull requests welcome. See [CONTRIBUTING.md](./CONTRIBUTING.md) for development setup, coding standards, and the test methodology for the transition solver.

---

## License

MIT © [Lancrey](https://github.com/Lancrey)
